 ...
 *
 * The {@code UpdateMonoSetupFX} class is the entry point for the Update Monochromator Setup window.
 */
public final class UpdateMonoSetupFX {
    
    private static volatile UpdateMonoSetupFX _instance = null;

    public static UpdateMonoSetupFX getInstance() throws Exception {
        
        // make local copy
        UpdateMonoSetupFX instance = UpdateMonoSetupFX._instance;
        
    	// Double-check locking pattern
    	if ( instance == null ) {   // 1st Check

            // Thread safe
            synchronized( UpdateMonoSetupFX.class ) {
                
                instance = UpdateMonoSetupFX._instance;
                
                if ( instance == null ) {   // 2nd Check

                    UpdateMonoSetupFX._instance = instance = new UpdateMonoSetupFX();
                }
            }
    	}
        
        return UpdateMonoSetupFX._instance;
    }
    ...
    private UpdateMonoSetupFX() throws Exception {
