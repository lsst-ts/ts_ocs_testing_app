...
public class UpdateMonoSetupController implements Initializable {
    ...
    @FXML private TextField entranceScrollText, exitScrollText, wavelengthText;
...
//    }
    ...
    @FXML private void gratingSelect( ActionEvent event ) {
    ...
    @FXML private void handleApply( ActionEvent event ) {
        ...
        argsMap.put( "1gratingType"          , Integer.parseInt  ( gratingMenub.getText() /*int*/ ));
        argsMap.put( "2fontEntranceSlitWidth", Double.parseDouble( entranceScrollText.getText() /*double*/ ));
        argsMap.put( "3fontExitSlitWidth"    , Double.parseDouble( exitScrollText.getText() /*double*/ ));
        argsMap.put( "4wavelength"           , Double.parseDouble( wavelengthText.getText() /*double*/ ));
    ...
    @FXML private void handleExit( ActionEvent event ) throws Exception {
        ...
        UpdateMonoSetupFX.getInstance().closeStage();
    }
}
